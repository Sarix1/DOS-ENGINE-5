...
#define INP_TYPE_KEYB   (BIT_0|BIT_1|BIT_2)
#define INP_TYPE_MOUSE  BIT_3
#define INP_TYPE_JOY    BIT_4
#define INP_TYPE_HID    BIT_5
...
#define EV_KEY_HIT  BIT_0
#define EV_KEY_REL  BIT_1
