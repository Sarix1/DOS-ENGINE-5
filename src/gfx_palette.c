...
void setVGAPaletteColor(byte index, RGB_t color)
{
    setVGAPaletteColor_RGB(index, color.r, color.g, color.b);
}

RGB_t getPaletteColor_VGA(byte index)
{
    RGB_t color;
...
void setPaletteColor(Palette_t* pal, byte index, RGB_t color)
{
    pal->colors[index] = color;
}

RGB_t getPaletteColor(Palette_t* pal, byte index)
{
...
byte findNearest(Palette_t* pal, RGB_t color)
{
    int i;
...
int buildGradient(RGB_t start, RGB_t end, RGB_t* gradient, int num_colors)
{
    int i;
